...
gulp.task('rtl', function () {
    return gulp.src(srcPath + 'css/style.ar.css')
        .pipe(rtlcss())
        .pipe(replace('@charset "UTF-8";', '/*# sourceMappingURL=maps/style.css.map */ @charset "UTF-8";'))
        // .pipe(rename({ extname: '.rtl.css' }))
        .pipe(gulp.dest(srcPath + 'css/'))
});

// deploy tasks
gulp.task('deploy', ['DeployCss', 'DeployCssmin', 'DeployJs', 'DeployImages','DeployFonts', 'deployHtml']);
